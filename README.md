...
SSR-веб-приложение на Nuxt 4, которое объединяет новости [Mos.ru](https://www.mos.ru/rss) и [РБК](https://rssexport.rbc.ru/rbcnews/news/30/full.rss), поддерживает поиск, фильтрацию, пагинацию и два адаптивных режима отображения.
...
Если Windows PowerShell блокирует `npm.ps1`, выполните [одноразовую настройку PowerShell](docs/development.md#windows-powershell). После неё команды выше запускаются без изменений.
